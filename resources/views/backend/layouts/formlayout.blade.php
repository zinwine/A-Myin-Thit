...
<div id="header">
    <h1>
        ...
        {{--<img src="{{asset('frontendone/photo/logo/logo.png')}}" alt="" class="img-responsive" width="">--}}
    </h1>
</div>
<!--close-Header-part-->
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        ...
        {{--<li class="submenu @yield('price')"><a href="#"><i class="icon icon-picture"></i> <span>Price</span></a>--}}
            {{--<ul>--}}
                {{--<li><a href="{{url('admin/price')}}">View Project Price</a></li>--}}
                {{--<li><a href="{{url('admin/price/create')}}">Add New Price</a></li>--}}
            {{--</ul>--}}
        {{--</li>--}}
        ...
        <li class="submenu @yield('career')"><a href="#"><i class="icon icon-picture"></i> <span>Career</span></a>
            <ul>
                <li><a href="{{url('admin/career')}}">View Posts</a></li>
                <li><a href="{{url('admin/career/create')}}">Add Career Post</a></li>
            </ul>
        </li>
        <li class="submenu @yield('message')"><a href="#"><i class="icon icon-envelope-alt"></i> <span>Message</span>
            ...
            <ul>
                <li><a href="{{url('admin/careermessage')}}"><span>Career message</span>
