...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="head_img">
                <h2>ေကာင္းမြန္လွပေသာဒီဇိုင္းမ ်ား</h2>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-8 service_detail">
                <img src="{{asset('frontend/photo/head/design.png') }}">
                <p class="text-justify">1996 ခုႏွစ္မွ ယေန႔ကာလအထိ နိုင္ငံေတာ္ တည္ေဆာက္ေရးတြင္သာမက
                    ...
                    စက္ရုံမ်ား၊ ေရေလွာင္ကန္မ်ား၊ေရကာတာႏွင့္ဆည္ႀကီးမ်ား၊ ေရအားလ
                    ွ်ပ္စစ္စက္ရုံႀကီးမ်ားႏွင့္အျခားေသာစက္မႈလုပ္ငန္းႏွင့္ ဆုိင္ေသာအေဆာက္အအံုႀကီးမ်ားကို
                    တည္ေဆာက္ေအာင္ျမင္ခဲ့ျပီးျဖစ္ပါသည္။
                </p>
