...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-8 service_detail">
                <img src="{{asset('frontend/photo/head/innovation.jpg') }}">
                <p class="text-justify">1996 ခုႏွစ္မွ ယေန႔ကာလအထိ နိုင္ငံေတာ္ တည္ေဆာက္ေရးတြင္သာမက
                    ...
                    အဆင့္ျမင့္အရာရွိႀကီးမ်ား၏ အိမ္ယာမ်ား ၊ေက်ာက္မ်က္ရတနာျပတိုက္၊ အစိုးရ၀န္ထမ္းမ်ားအတြက္
                    ေနအိမ္တိုက္ခန္းမ်ား၊ နည္းပညာတကၠသိုလ္မ်ား ၊ေဆးရုံမ်ား၊ မုန္တိုင္းခံအေဆာက္အဦးမ်ား(Cyclone shelters)၊
                    ေစတီပုထိုးမ်ား၊ ဘာသာေရးႏွင့္ ဆိုင္ေသာအေဆာက္အဦးမ်ား၊ စက္ရုံမ်ား၊ ေရေလွာင္ကန္မ်ား၊ေရကာတာႏွင္
                    ့ဆည္ႀကီးမ်ာေရအားလ ွ်ပ္စစ္စက္ရုံႀကီးမ်ားႏွင့္အျခားေသာ
                    စက္မႈလုပ္ငန္းႏွင့္ ဆုိင္ေသာအေဆာက္အအံုႀကီးမ်ားကို တည္ေဆာက္ေအာင္ျမင္ခဲ့ျပီးျဖစ္ပါသည္။
                </p>
            ...
            <div class="col-sm-4" style="margin-bottom: 10px">
                <div class="servicelist">
                    ...
                    <a href="{{ url('/support') }}" style="text-decoration: none">
                        <div class="media showsevice">
                            <div class="media-left">
                                <img src="{{ asset('frontend/photo/head/support.jpg') }}" alt="Support"
                                     class="media-object"
                                     style="width:60px;height: 60px">
                            </div>
                            <div class="media-body">
                                <h4 class="media-heading" style=" font:bold 17px Geogria,Times New Roman,Times,serif;">
                                    ေဆာက္လုပ္ေရးပစၥည္းမ ်ားေကာင္းျခင္း</h4>
                                <p class="text-justify">1996ခုႏွစ္မွယေန႔ကာလအထိ နိုင္ငံေတာ္တည္ေဆာက္ေရးတြင္သာမက
                                    ပုဂၢလိကတည္ေဆာက္ေရးလုပ္ငန္းတြင္ပါ ေဆာက္လုပ္ေရးစီမံကိန္းလုပ္ငန္းမ်ားကို</p>
                            </div>
                        </div>
                    ...
                    <a href="{{ url('/pro') }}" style="text-decoration: none;">
                        <div class="media showsevice">
                            ...
                            <div class="media-left">
                                <img src="{{ asset('frontend/photo/head/pro.jpg') }}" alt="" class="media-object"
                                     style="width:60px;height: 60px">
                            </div>
                            <div class="media-body">
                                <h4 class="media-heading" style=" font:bold 17px Geogria,Times New Roman,Times,serif;">
                    ...
                    <a href="{{ url('/design') }}" style="text-decoration: none">
                        <div class="media showsevice">
                            <div class="media-left">
                                <img src="{{ asset('frontend/photo/head/design.png') }}" alt="safety"
                                     class="media-object"
                                     style="width:60px;height: 60px">
                            </div>
                            <div class="media-body">
